...
- `node scripts/manual/validate-vod-fix.cjs`: 제보된 공개 채널의 VOD를 2.3.1과 현재 소스로 비교하고, 본편 2개에서 각각 64 KiB를 요청합니다. 네트워크를 사용하며 서명 URL이나 inKey를 결과에 저장하지 않습니다. 영상이 삭제되거나 재생 정보가 바뀌면 재현 조건이 달라질 수 있습니다.
