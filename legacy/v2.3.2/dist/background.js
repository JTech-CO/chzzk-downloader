// Chzzk Downloader v2.3.2 - durable jobs and browser download coordination.
importScripts('download-core.js', 'media-plan.js');
// This is the loaded code version; the manifest may already have been replaced on disk.
const RUNTIME_VERSION = '2.3.2';
...
chrome.runtime.onInstalled.addListener(() => { installHeaderRules().catch(console.error); });
installHeaderRules().catch(console.error);
