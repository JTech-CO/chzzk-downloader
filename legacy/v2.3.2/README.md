...
네이버 치지직의 VOD와 클립을 MP4로 저장하는 Chrome 확장 프로그램입니다. 현재 버전은 `2.3.2`입니다.
...
다운로드 시작 시 저장 공간 부족으로 잘못 차단하던 문제를 수정했습니다. 실제 임시 저장 한도에 도달한 직접 MP4는 Chrome 기본 다운로드로 전환합니다.

수정 내용과 검증 결과는 [버그 리포트](docs/bug-report.md)에 있으며, 개인정보 처리방침은 [이 문서](<https://jtech-co.github.io/chzzk-downloader/docs/privacy-policy.html>)에 있습니다.
